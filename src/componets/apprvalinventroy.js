...
function UpdateGroup(props) {
    ...
    useEffect(() => {
        ...
        fetch("https://dagduteli.com/Inventory/backend/approvalItemData.php?id="+id)
        .then(res => res.json())
        .then(
          (result) => {
            ...
            setReason(result[0].approvalReason);
    ...
    function create(st) {
        ...
        const data = new FormData() 
         ...
         data.append('approval',st)
         data.append('approvalRes',reason)
          

         let url = "https://dagduteli.com/Inventory/backend/ApprvDt.php";
         axios.post(url, data, { })
         .then(res => { 
    ...
    return(
        ...
        <div class="MuiPaper-root MuiCard-root MuiPaper-elevation3 MuiPaper-rounded" style={{ padding:"20px" }}>
            <div class="flex p-4"><h4 class="m-0"><b>Approval Inventory</b></h4></div>
               ...
               ></input>
                ...
                <Row className="show-grid">
                 ...
                 <Row className="show-grid">
                    ...
                    <Col md={3}>
                    <label style={{ width:"100%",marginLeft:"30%",marginTop:"20px"}}>Reason: </label>
                ...
                <Row className="show-grid"  style={{ marginLeft:"90px",marginBottom:"50px"}}>
                    ...
                    <Button
                          ...
                          size="large"
                          onClick={() => create('true')}
                          style={{ backgroundColor:"#e43f31", margin: "10px"}}
                        ...
                        <Button
                          ...
                          style={{ marginLeft:"50px",backgroundColor:"#a0ea66"}}
